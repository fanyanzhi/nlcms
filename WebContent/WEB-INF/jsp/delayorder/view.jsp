...
<script type="text/javascript">
	...
	$(function(){
		...
		tab = $('#dataTable').datagrid({
			//数据来源
			url:'${ctx}/session/delayorderinfo/list',
			//斑马纹
			striped:true,
			//主键字段
			idField:"id",
			...
			columns:[[
				...
				
				{
					...
					formatter : function(value, row, index) {
						return "<a href='#' onclick=logInfo('"+row.orderno+"')>查看详情</a>";
					}
				}
			]],
			toolbar : '#tbr',
	...
	function exportInfo() {
		...
		document.getElementById("tempForm").action = "${ctx}/session/delayorderinfo/export";
	...
	//查看详情
	function logInfo(orderno) {
		$('#dataTable').datagrid("clearSelections");
		openWin2("查看详情", "${ctx}/session/delayorderinfo/detail?orderno=" + orderno, 800, 500);
	}
