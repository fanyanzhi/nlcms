...
<script type="text/javascript">
	$(function(){
		...
		var z1 = "${librarymap.src}";
		var z2 = "${librarymap.src2}";
		var z3 = "${librarymap.src3}";
		var z4 = "${librarymap.src4}";
		var z5 = "${librarymap.src5}";
		var z6 = "${librarymap.src6}";
		var z7 = "${librarymap.src7}";
		var z8 = "${librarymap.src8}";
		...
		if(z8) {
			$("#src8").val(z8);
			var html8 = '<img style="width: 30px; height: 30px;" onclick=amp("'+z8+'") src="'+z8+'"/>';
			$("#s8").empty().append(html8);
		}
		...
		$("#saveBtn").click(function(){
			...
			var seq = $('#seq').numberbox('getValue');
			 ...
			 $.ajax({
				url: "${ctx}/session/librarymap/updateMap",
				data: {"name":name, "src":src, "src2":src2, "src3":src3, "src4":src4, "src5":src5, "src6":src6, "src7":src7, "src8":src8, "id":id, "seq":seq},
				cache: false,
	            type: "POST",
...
<form id="form1" action="" method="POST">
	<table align="center">
		<tr>
			...
			<td width="20%"><input type="text" id="name" name="name" class="easyui-validatebox" required data-options="validType:['specialy','isBlank','length[0,30]']" value="${librarymap.name }"/></td>
			<td width="20%"></td>
			<td width="20%"></td>
			<td width="20%"></td>
		</tr>
		...
		<tr>
			...
			<td width="20%"><input type="text" id="seq" name="seq" class="easyui-numberbox" data-options="required:true,max:100,min:0" value="${librarymap.seq }"/></td>
			<td width="20%"></td>
			<td width="20%"></td>
			<td width="20%"></td>
		</tr>
