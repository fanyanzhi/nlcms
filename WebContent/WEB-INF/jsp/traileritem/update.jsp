	...
	<form id="messageForm">
		<table>
			<tr>
				...
				<td>
					<input type="text" id="columnname" style="width:200px" name="columnname" class="easyui-validatebox" required data-options="validType:['isBlank','length[0,60]']" value="${columndic.columnname}"/>
				</td>
			</tr>
		</table>
	</form>
...
<script>
	...
	$(function(){
		...
		$("#saveBtn").click(function(){
			...
			$.ajax({
                url: "${ctx}/session/columndic/updateColumn",
