...
<div>
	<form id="messageForm">
		<table align="center">
			...
			<tr>
				<td width="20%" align="left" colspan="2">To：全体读者</td>
			</tr>
			
			<tr>
				<td width="20%" align="left">标题：</td>
				<td>
					<input type="text" id="title" style="width:300px" name="title" class="easyui-validatebox" required data-options="validType:['specialy','isBlank','length[0,60]']" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea class="comments easyui-validatebox" validType="length[0, 1000]" rows="4" id="message" name="message" style="width: 460px; height: 150px;"></textarea>
				</td>
			</tr>
...
<script>
	...
	$(function(){
		...
		$("#saveBtn").click(function(){
			...
			$.ajax({
                url: "${ctx}/session/message/addMessage",
