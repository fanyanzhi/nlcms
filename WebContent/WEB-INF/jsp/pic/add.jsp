...
<script type="text/javascript">
	$(function(){
		...
		$("#saveBtn").click(function(){
			...
			$.ajax({
				url: "${ctx}/session/picture/addPic",
...
<form id="form1" action="" method="POST">
	<table align="center" width="90%" >
		<tr>
			...
			<td ><input type="text" id="name" style="width:210px" name="name" class="easyui-validatebox" required data-options="validType:['specialy','isBlank','length[0,30]']" /></td>
		</tr>
		
		<tr>
			<td width="20%" align="right">图片：<br/><span style="font-size:12px;">(1008x375)</span>&nbsp;</td>
