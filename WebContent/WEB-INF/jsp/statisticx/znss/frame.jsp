...
<font style="font-family:黑体">站内搜索</font>
<br/>
<table border="0">
		<tr>
			<td>&nbsp;</td>
...
$(function(){
	$("#winfra").attr("src", "${ctx}/session/statisticx/znssSearchYmfwGrid?status=day&startDate=${lastmonth}&endDate=${yesterday}&r="+Math.random());
});
...
function staday() {
	...
	$("#winfra").attr("src", "${ctx}/session/statisticx/znssSearchYmfwGrid?status=day&startDate="+ws+"&endDate="+we+"&r="+Math.random());
}
...
function stamon() {
	...
	$("#winfra").attr("src", "about:blank");
	$("#winfra").attr("src", "${ctx}/session/statisticx/znssSearchYmfwGrid?status=month&startDate="+s+"&endDate="+e+"&r="+Math.random());
}
...
function stayear() {
	...
	$("#winfra").attr("src", "about:blank");
	$("#winfra").attr("src", "${ctx}/session/statisticx/znssSearchYmfwGrid?status=year&startDate="+s+"&endDate="+e+"&r="+Math.random());
}
...
function staweek() {
	...
	$("#winfra").attr("src", "about:blank");
	$("#winfra").attr("src", "${ctx}/session/statisticx/znssSearchYmfwGrid?status=week&startDate="+ws+"&endDate="+we+"&r="+Math.random());
}
