...
<font style="font-family:黑体">书架</font>
<br/>
<table border="0">
		<tr>
			<td>&nbsp;</td>
	...
	<font id="tit1" style="font-family:黑体">访问量:</font>
	<div>
...
$(function(){
	$("#winfra").attr("src", "${ctx}/session/statisticx/sjYmfwGrid?status=day&startDate=${lastmonth}&endDate=${yesterday}&r="+Math.random());
});
...
function staday() {
	...
	$("#winfra").attr("src", "${ctx}/session/statisticx/sjYmfwGrid?status=day&startDate="+ws+"&endDate="+we+"&r="+Math.random());
}
...
function stamon() {
	...
	$("#winfra").attr("src", "about:blank");
	$("#winfra").attr("src", "${ctx}/session/statisticx/sjYmfwGrid?status=month&startDate="+s+"&endDate="+e+"&r="+Math.random());
}
...
function stayear() {
	...
	$("#winfra").attr("src", "about:blank");
	$("#winfra").attr("src", "${ctx}/session/statisticx/sjYmfwGrid?status=year&startDate="+s+"&endDate="+e+"&r="+Math.random());
}
...
function staweek() {
	...
	$("#winfra").attr("src", "about:blank");
	$("#winfra").attr("src", "${ctx}/session/statisticx/sjYmfwGrid?status=week&startDate="+ws+"&endDate="+we+"&r="+Math.random());
}
