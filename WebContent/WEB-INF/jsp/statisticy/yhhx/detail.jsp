...
<script type="text/javascript">
	...
	$(function(){
		...
		tab = $('#dataTable').datagrid({
			//数据来源
			url:'${ctx}/session/statisticy/detailList',
			//斑马纹
			striped:true,
			//主键字段
			//idField:"xxx",
	...
	function exportInfo() {
		...
		document.getElementById("tempForm").action = "${ctx}/session/statisticy/yhhxDetailExport";
...
<div>
	...
	<form id="tempForm">
		...
		<input type="hidden" name="loginaccount" id="loginaccount">
	</form>
</div>
</body>
</html>