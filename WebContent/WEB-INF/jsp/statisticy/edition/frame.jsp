...
function exportInfo() {
	...
	document.getElementById("tempForm").action = "${ctx}/session/statisticy/editionExport";
	document.getElementById("tempForm").submit();
}

$(function(){
	$("#winfra").attr("src", "${ctx}/session/statisticy/editionTable?status=day&startDate=${lastmonth}&endDate=${yesterday}&r="+Math.random());
});
...
function staday() {
	...
	$("#winfra").attr("src", "${ctx}/session/statisticy/editionTable?status=day&startDate="+ws+"&endDate="+we+"&r="+Math.random());
}
...
function stamon() {
	...
	$("#winfra").attr("src", "about:blank");
	$("#winfra").attr("src", "${ctx}/session/statisticy/editionTable?status=month&startDate="+s+"&endDate="+e+"&r="+Math.random());
}
...
function stayear() {
	...
	$("#winfra").attr("src", "about:blank");
	$("#winfra").attr("src", "${ctx}/session/statisticy/editionTable?status=year&startDate="+s+"&endDate="+e+"&r="+Math.random());
}
...
function staweek() {
	...
	$("#winfra").attr("src", "about:blank");
	$("#winfra").attr("src", "${ctx}/session/statisticy/editionTable?status=week&startDate="+ws+"&endDate="+we+"&r="+Math.random());
}
