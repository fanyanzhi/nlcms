...
<script type="text/javascript">
	...
	$(function(){
		...
		tab = $('#dataTable').datagrid({
			//数据来源
			url:'${ctx}/session/statistic/zyhxtableList',
			//斑马纹
			striped:true,
			//主键字段
			//idField:"xxx",
			...
			columns:[[
				...
				<c:if test="${zytype ne '2' and zytype ne '3' }">
					,{
						field : 'xznum',
						title : '下载量',
						width : 100
	...
	function exportInfo() {
		$("#sdt").val(p1);
		$("#edt").val(p2);
		document.getElementById("tempForm").action = "${ctx}/session/statistic/zyhxExport";
...
<div>
	...
	<form id="tempForm">
		...
		<input type="hidden" name="zytype" id="zytype"  value="${zytype }">
	</form>
</div>
