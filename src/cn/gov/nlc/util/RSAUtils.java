...
public class RSAUtils {
	...
	public static Map<String, String> genKeyPair() throws Exception {
		...
		keyMap.put(PUBLIC_KEY, Base64Utils.encode(publicKey.getEncoded()).replaceAll("\n", ""));
		keyMap.put(PRIVATE_KEY, Base64Utils.encode(privateKey.getEncoded()).replaceAll("\n", ""));
		return keyMap;
	}
	...
	public static String getPrivateKey(Map<String, String> keyMap) throws Exception {
		/*
		 * Key key = (Key) keyMap.get(PRIVATE_KEY); return
	...
	public static String getPublicKey(Map<String, String> keyMap) throws Exception {
		/*
		 * Key key = (Key) keyMap.get(PUBLIC_KEY); return
		 * Base64Utils.encode(key.getEncoded());
		 */
